...
app.get("/sanketSirTask", authentication, (req, res) => {
    res.sendFile("/home/tirth-raval/Documents/one_union_form/views/sanket_sir_task/index.html");
});

app.get("/details", authentication, (req, res) => {
    res.render("/home/tirth-raval/Documents/one_union_form/views/sanket_sir_task/personal.ejs");
});
